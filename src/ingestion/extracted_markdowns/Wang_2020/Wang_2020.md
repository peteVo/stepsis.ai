ORIGINAL RESEARCH published: 17 December 2020 doi: 10.3389/fmed.2020.593808 


![](extracted_markdowns/Wang_2020/images/Wang_2020.pdf-0001-01.png)

> [!IMPORTANT]
> **AI Visual Analysis (Wang_2020.pdf-0001-01.png)**
> **Category:** `OTHER` | **Summary:** Software Update Icon
> 
> The image shows a software update icon with a bookmark and circular arrow. It has a gray background and is used in application interfaces to signify updates or upgrades.
<!-- analyzed_Wang_2020.pdf-0001-01.png -->
...
Reviewed by: Massimo Girardis, University Hospital of Modena, Italy Chun-Ta Huang, National Taiwan University Hospital, Taiwan 

*Correspondence: Yan He yanhe1220@126.com Xiuming Xi xixiuming2937@sina.com 
...
Received: 11 August 2020 Accepted: 16 November 2020 Published: 17 December 2020 

Citation: 

Wang M, Jiang L, Zhu B, Li W, Du B, Kang Y, Weng L, Qin T, Ma X, Zhu D, 

Wang Y, Zhan Q, Duan M, Li W, Sun B, Cao X, Ai Y, Li T, Zhu X, Jia J, Zhou J, He Y, Xi X and China Critical Care Sepsis Trial (CCCST) workgroup (2020) The Prevalence, Risk Factors, and Outcomes of Sepsis in Critically Ill 

Patients in China: A Multicenter Prospective Cohort Study. 

Front. Med. 7:593808. doi: 10.3389/fmed.2020.593808 
...
December 2020 | Volume 7 | Article 593808 
...
in-hospital mortality; the lengths of ICU and hospital stays were secondary outcomes. 
...
![](extracted_markdowns/Wang_2020/images/Wang_2020.pdf-0004-02.png)

> [!IMPORTANT]
> **AI Visual Analysis (Wang_2020.pdf-0004-02.png)**
> **Category:** `DIAGRAM_OR_TABLE` | **Summary:** Flowchart of Patient Enrollment and Categorization for ICU Study in China
> 
> The image is a flowchart illustrating the process of patient enrollment and categorization in a study conducted in ICUs of 16 tertiary hospitals in six geographical regions of China. The timeline is from January 1, 2014, to August 31, 2015. It begins with 14604 consecutive patient admissions, outlining various exclusion criteria, leading to a final categorization into non-sepsis and sepsis groups, with further subdivisions in the sepsis category. The chart uses simple boxes and lines to depict decision points and outcomes, with clear labeling of each stage and count.
> 
> **Data Points:** Total Patients Admitted: 14604; Excluded: 9088 (aged < 18 years: 589, length of ICU stay < 24 hours: 7941, readmitted to ICUs: 376); Met Inclusion: 5516; Withdrew: Therapy within 48 hours; Patients Enrolled: 5229; Insufficient Data: 319; Final Enrollment: 4910; Non-sepsis: 2824 (57.5%); Sepsis: 2086 (42.5%); Sepsis without shock: 952 (45.6%); Sepsis shock: 1134 (54.4%)
> 
> **Key Findings:**
> - A large proportion of patients (9088 out of 14604) were excluded primarily due to short ICU stays.
> - Out of the remaining patients, a significant number withdrew therapy or had insufficient data.
> - Final enrollment showed a higher number of non-sepsis patients (2824) compared to sepsis (2086).
> - Within the sepsis group, more patients had sepsis shock (1134) than sepsis without shock (952).
<!-- analyzed_Wang_2020.pdf-0004-02.png -->




FIGURE 1 | Flowchart of all the participants during the study period. ICU, intensive care unit. 
...
||All patients<br>(n=4,910)|Non-sepsis<br>(n=2,824)|Sepsis<br>(n=2086)|P-value|
|---|---|---|---|---|
...
|No. of comorbidities,n<br>(%)<br>None<br>1<br>2<br>≥3<br>~~Treatment~~|1,611 (32.9)<br>1,932 (39.2)<br>834 (17.0)<br>533 (10.9)|1,087 (38.5)<br>1,031(36.5)<br>442 (15.7)<br>264 (9.3)|524 (25.1)<br>1,932 (39.2)<br>392 (18.8)<br>269 (12.9)|<0.001|
...
|Hospital|17.0|17.0|18.0|0.002|
||(10.0–27.0)|(10.0–25.0)|(10.0–29.0)||
|~~Mortality, n (%)~~|||||
...
|||n|Origin of infection,n(%)|Origin of infection,n(%)|||Severity of sepsis,n(%)|||
|---|---|---|---|---|---|---|---|---|---|
...
|||All|Community-acquired|Hospital-acquired|P-value||
|---|---|---|---|---|---|---|
|||(n=2,086)|(n=1,181)|(n=905)|||
...
SOFA, Sequential Organ Failure Assessment; res, respiratory; CNS, central nervous system; IQR, interquartile range; ARDS, acute respiratory distress syndrome; AKI, acute kidney injury; ICU, intensive care unit. 
...
|---|---|---|---|
||(n=692)|(n=442)||
|~~Intravenous fuid administration, ml/kg~~<br>- 3 h, median (IQR)<br>24.2 (11.1–30.6)||21.1 (14.1–30.5)|0.741|
...
|During frst 3 h|302 (43.6)|143 (32.4)|<0.001|
|During frst 6 h|213 (30.8)|126 (28.5)|0.238|
|~~Vasopressor administration, n (%)~~||||
|During frst 3 h|360 (52.0)|254 (57.5)|0.073|
|During frst 6 h|394 (56.9)|281 (63.6)|0.026|
|During frst 24 h|457 (66.0)|315 (71.3)|0.066|
...
regions, which was similar to the result reported by Xie et al. (17). Patients in Southwest China had a relatively high mortality rate, which may be related to the relatively underdeveloped economy. Previous studies have found that a low gross national income 

was associated with a higher mortality rate (12), especially in low-income countries (30, 31). However, we did not find significantly different outcomes when sepsis was defined using the Sepsis-1 and Sepsis-3 definitions. 
...
![](extracted_markdowns/Wang_2020/images/Wang_2020.pdf-0008-04.png)

> [!IMPORTANT]
> **AI Visual Analysis (Wang_2020.pdf-0008-04.png)**
> **Category:** `SCIENTIFIC_GRAPH` | **Summary:** Incidence and Mortality Rates by Number of Organ Dysfunctions
> 
> The graph features a combination of a bar chart and a line graph. The bars, in blue, represent the incidence percentage and are plotted against the left y-axis. The orange line graph represents the mortality percentage, aligned with the right y-axis. Both datasets are plotted against the x-axis, which categorizes based on the number of organ dysfunctions (0, 1, 2, ≥3).
> 
> **Data Points:** X-axis: Number of organ dysfunction; Y-axis left: Incidence (%); Y-axis right: Mortality (%); Data points: 0 dysfunctions (Incidence: 38.7%, Mortality: 7.9%), 1 dysfunction (Incidence: 27.6%, Mortality: 9.2%), 2 dysfunctions (Incidence: 22.7%, Mortality: 22.5%), ≥3 dysfunctions (Incidence: 10.8%, Mortality: 57.3%)
> 
> **Key Findings:**
> - Incidence decreases with an increasing number of organ dysfunctions.
> - Mortality increases substantially with more organ dysfunctions.
> - Mortality is significantly high (57.3%) for patients with ≥3 organ dysfunctions.
<!-- analyzed_Wang_2020.pdf-0008-04.png -->
...
|Category|Mortality, % (95% CI)|Mortality, % (95% CI)|Unadjusted|Unadjusted|
|---|---|---|---|---|
||||ORs (95% CI)||
||ICU|Hospital|||
|~~Site of infection~~#|||||
...
|Staphylococcus<br>Enterococcus<br>Gram–negative<br>Acinetobacter|56.0 (49.6–62.5)<br>40.2 (31.7–48.6)<br>35.1 (32.1–38.1)<br>44.9 (39.8–50.0)|61.6 (55.3–67.9)<br>46.2 (37.6–54.8)<br>41.5 (38.4–44.7)<br>51.4 (46.2–56.5)|3.18 (2.38–4.27)<br>1.37 (0.95–1.99)<br>1.31 (1.00–1.73)<br>1.99 (1.56–2.65)||
...
||30 mL/kg initial resuscitation during frst 3 h||0.43 (0.30–0.63)|<0.001|
...
point-prevalence study. Crit Care. (2018) 22:93. doi: 10.1186/s13054-0182013-1 
...
32. Vincent JL, Rello J, Marshall J, Silva E, Anzueto A, Martin CD et al. International study of the prevalence and outcomes of infection in 
   ...
   - intensive care units. JAMA. (2009) 302:2323–9. doi: 10.1001/jama.200 9.1754 
